          ...
          */}
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="flex flex-shrink-0 items-center">
                            <img className="h-8 w-auto" src="/src/img/favicon.jpg" alt="Company Logo" />
                        </div>
                        {/* Navbar */}
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                {/* Current: "bg-gray-900 text-white", Default: "text-gray-50 hover:bg-orange-500 hover:text-white" */}
                                <a href="/" className="bg-orange-500 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                                <a href="/about/" className="text-gray-50 hover:bg-orange-500 hover:text-white rounded-md px-3 py-2 text-sm font-medium">About</a>
                                <a href="/stories" className="text-gray-50 hover:bg-orange-500 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Stories</a>
                                <a href="/contacts/" className="text-gray-50 hover:bg-orange-500 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Contact Us</a>
                            </div>
                        </div>
                    </div>
                            ...
                            </div>
                            {
                                profileState ?
                                    <div className="flex flex-col items-center absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" >
                                        ...
                                        <a href="#" className="px-4 py-2 text-sm text-gray-700 flex items-center justify-between space-x-3 hover:bg-orange-500 hover:text-white rounded-md w-11/12" role="menuitem" id="user-menu-item-0">
                                            <div className="flex space-x-4 hover:text-white">
