        ...
        <>
            <div className="h-full w-[30%] bg-slate-50 border-r md:flex flex-col hidden">
                <div className="h-16 border-b px-4 flex items-center justify-center space-x-4">
                    <div className="px-4 py-4 border-b-4 border-b-primary-500">All</div>
                ...
                <div className="h-full">
                    ...
                    <div
                        className="px-5 py-4   flex items-center bg-white cursor-pointer border-l-4 border-l-primary-500 border-t border-b">
                ...
                <div className="h-16 border-b flex justify-between items-center w-full px-5 py-2 shadow-sm">
                    <div className="flex items-center">
                        <img className="h-10 w-10 overflow-hidden rounded-full"
                            src="/src/img/dummy/avatar.jpg"
                            alt="" />
                        <p className="font-semibold ml-3 text-slate-600">{session?.user?.name}</p>
                    </div>
                ...
                <div className="h-full px-10 py-4">
                    ...
                    <div className="w-full flex justify-end mt-3">
                        <div className="w-1/2 ">
                            ...
                            <div className="mt-3 w-full bg-primary-500 p-4 rounded-b-xl rounded-tl-xl">
