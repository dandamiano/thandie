                ...
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        ...
                        <div className="w-full flex justify-center  px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button onClick={onClose} type="button" className="mt-3 inline-flex w-full justify-center rounded-md text-white bg-green-700 px-3 py-2 text-sm font-semibold shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-green-800 sm:mt-0 sm:w-auto">OK</button>
                        </div>
                    </div>
                </div>
            </div>
