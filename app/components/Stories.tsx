    ...
    return (
        <div className="relative flex min-h-screen flex-col justify-center overflow-hidden py-6 sm:py-12">
            <div className="mx-auto max-w-screen-xl px-4 w-full">
                <h2 className="mb-4 font-bold text-xl text-gray-600">Latest Stories.</h2>
                <div className="grid w-full sm:grid-cols-2 xl:grid-cols-4 gap-6">
                    ...
                    <div className="relative flex flex-col shadow-md rounded-xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 max-w-sm">
                        <a href="" className="hover:text-primary-600 absolute z-30 top-2 right-0 mt-2 mr-3">
                        ...
                        <div className="h-auto overflow-hidden">
                            <div className="h-44 overflow-hidden relative">
                                <img src="/src/img/dummy/post1.jpg" alt="" />
                            </div>
                        </div>
                        <div className="bg-white py-4 px-3">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="relative z-40 flex items-center gap-2">
                                    <a className="text-primary-600 hover:text-blue-500" href="">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
