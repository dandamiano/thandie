                ...
                <ul className="flex items-start justify-between gap-8 mt-10 md:flex-row flex-col">
                    <li
                        ...
                        <p className="text-center tracking-tighter block mb-14">
                            <span className="text-4xl font-bold">K50,000</span>
                            <span className="text-black/40 text-center">/mo</span>
                        </p>
                        <button className="w-full p-2 bg-[#13181f] text-white rounded-md font-semibold hover:bg-primary-500 transition-all duration-150 ease-in mb-8 border-[#13181f]">subscribe</button>
                    ...
                    <li
                        ...
                        <div
                            className="absolute top-0 left-1/2 -translate-x-1/2 rounded-br-xl rounded-bl-xl text-white px-8 py-2 bg-primary-500 transition-all duration-150 ease-in group-hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)]">
                            50% off
                        </div>
                        <h2
                            className="text-center font-semibold text-lg tracking-wider mb-3 drop-shadow-[3px_3px_5px_rgba(91,91,91,0.58)]">
                            Premium Cover</h2>
                        <p className="text-center tracking-tighter block mb-14">
                            <span className="text-4xl font-bold">K80,000</span>
                            <span className="text-black/40 text-center">/mo</span>
                        </p>
                        <button className="w-full p-2 bg-[#13181f] text-white rounded-md font-semibold hover:bg-primary-500 transition-all duration-150 ease-in mb-8 border-[#13181f]">subscribe</button>
                        <ol className="list-disc text-primary-500 w-[80%] mx-auto">
                    ...
                    <li
                        className="w-full lg:w-[32%] px-10 pt-16 pb-8 bg-white rounded-lg self-stretch hover:scale-105 hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)] transition-all duration-150 ease-in relative group">
                        <div
                            className="absolute top-0 left-1/2 -translate-x-1/2 rounded-br-xl rounded-bl-xl bg-[#e2e2e2] text-black px-8 py-2 group-hover:bg-primary-500 group-hover:text-white transition-all duration-150 ease-in group-hover:shadow-[0px_14px_28px_-5px_rgba(0,0,0,0.1)]">
                            10% off
                        </div>
                        <h2
                            className="text-center font-semibold text-lg tracking-wider mb-3 drop-shadow-[3px_3px_5px_rgba(91,91,91,0.58)]">
                            Family Cover</h2>
                        <p className="text-center tracking-tighter block mb-14">
                            <span className="text-4xl font-bold">K100,000</span>
                            <span className="text-black/40 text-center">/mo</span>
                        </p>
                        <button className="w-full p-2 bg-[#13181f] text-white rounded-md font-semibold hover:bg-primary-500 transition-all duration-150 ease-in mb-8 border-[#13181f]">subscribe</button>
                        <ol className="list-disc text-primary-500 w-[80%] mx-auto">
