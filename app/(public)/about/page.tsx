        ...
        <div className=" 2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            ...
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                <div className="w-full lg:w-6/12">
                    <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">Building your future? Secure it with the right insurance.</h2>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Get insured instantly. Life doesn't wait for paperwork.Your unique needs deserve personalized coverage.Simple online application & 24/7 customer support.We are committed to helping you prevent losses and manage risks. We offer a variety of loss prevention and risk management services, including safety tips, home security discounts, and driver education programs.We have a network of experienced agents located throughout the region who are ready to assist you with all of your insurance needs.We know that filing a claim can be stressful, so we've made the process as easy as possible. Our online portal and mobile app allow you to file claims quickly and easily, and you can track the progress of your claim in real-time.</p>
                </div>
                <div className="w-full lg:w-6/12">
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                <div>
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Is your current insurance enough? Get a free quote and find out..</p>
                </div>
                <div>
            ...
            <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                <div className="w-full lg:w-6/12">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">Is your current insurance enough? Get a free quote and find out.. The point of using Lorem Ipsum.In the first place we have granted to God, and by this our present charter confirmed for us and our heirs forever that the English Church shall be free, and shall have her rights entire, and her liberties inviolate; and we will that it be thus observed; which is apparent from</p>
                    <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">Is your current insurance enough? Get a free quote and find out.. The point of using Lorem Ipsum.In the first place we have granted to God, and by this our present charter confirmed for us and our heirs forever that the English Church shall be free, and shall have her rights entire, and her liberties inviolate; and we will that it be thus observed; which is apparent from</p>
                </div>
                <div className="w-full lg:w-6/12">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                        ...
                        <div className="flex p-4 shadow-md shadow-orange-500 hover:shadow-orange-600 hover:scale-105 transition-all">
                            ...
                            <div className="">
                                ...
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Is your current insurance enough? Get a free quote and find out..</p>
                            </div>
                        </div>
